...
from strategy.trigger import SimpleTrigger, IndicatorTrigger, convert_string_trigger_to_obj
...
class Trader:
    ...
    def buy(self):
        t = convert_string_trigger_to_obj(self.trade.strategy.buy_trigger)
        if t.eval_trigger_condition(self.data):
            self.place_order(buy=True)
        pass

    def sell(self):
        t = convert_string_trigger_to_obj(self.trade.strategy.sell_trigger)
        stop = convert_string_trigger_to_obj(self.trade.strategy.stop_trigger)
